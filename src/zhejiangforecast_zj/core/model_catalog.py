...
MODEL_CATALOG: dict[str, ModelSpec] = {
    ...
    "EC_XGB_PV_V1": ModelSpec(
        ...
        required_features=("nwp_stats", "lead_time"),
        description="PV fast tabular baseline.",
    ),
    "EC_LGB_PV_V1": ModelSpec(
        name="EC_LGB_PV_V1",
        station_type="solar",
        model_family="lgb",
        feature_set="ec_pv_tabular_v1",
        required_features=("nwp_stats", "lead_time"),
        description="PV LightGBM tabular baseline.",
    ),
    "EC_XGB_WIND_V1": ModelSpec(
        name="EC_XGB_WIND_V1",
        station_type="wind",
        model_family="xgb",
        feature_set="ec_wind_tabular_v1",
        required_features=("nwp_stats", "lead_time"),
        description="Wind XGBoost tabular baseline.",
    ),
