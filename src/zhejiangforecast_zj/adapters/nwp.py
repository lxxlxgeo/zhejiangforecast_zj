...
from zhejiangforecast_zj.adapters.external_projects import enable_external_project
...
def build_nwp_power_datasets(
    *,
    ...
    try:
        enable_external_project("nwp_downscaling")
    ...
    paths = {
        ...
        "ml_baseline_pkl": str(out_dir / "ml_baseline_dataset.pkl"),
    }
    ...
    _write_ml_baseline_pickle(frame, feature_names, paths["ml_baseline_pkl"])
    summary = {
        "check_result": "PASS",
...
def _write_ml_baseline_pickle(frame: pd.DataFrame, feature_names: list[str], path: str | Path) -> None:
    import pickle
